  ...
  return (
    <label className="inline-flex items-center relative">
      ...
      <svg
        ...
        className="fill-yellow-500 peer-checked:opacity-60 absolute w-6 h-6 left-[13px]"
      >
