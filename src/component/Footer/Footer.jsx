...
// import img from "../../assets/photo_2025-12-14_15-43-04-removebg-preview.png";
...
export const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-neutral-primary-soft container mx-auto bottom-0 relative">
        <div className="mx-auto w-full  p-4 py-6 lg:py-8">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a to="#" className="text-body hover:text-heading">
                <svg
                  className="w-5 h-5"
                  aria-hidden="true"
              ...
              <a to="#" className="text-body hover:text-heading ms-5">
                <svg
                  className="w-5 h-5"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
